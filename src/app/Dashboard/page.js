  ...
  return(
    ...
    <div className="bg-gradient-to-br from-blue-600 to-purple-500 text-gray-200  h-32 w-full lg:w-3/4 max-w-3xl rounded-lg px-2">
      ...
      <div className="flex flex-wrap -m-4">
        ...
        <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl sm-w-full max-w-96">
    <div className="p-6">
    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="black" className="bi bi-patch-question-fill" viewBox="0 0 16 16">
...
Elevate Your Understanding: Ask a Doubt Today!
      </p>
    </div>
    ...
    <div className="p-6">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" class="w-12 h-12">
